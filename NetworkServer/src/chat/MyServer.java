...
public class MyServer {
    ...
    public void sendPrivateMessage( String s, String userNamePrivateMessage) throws IOException {
        for (ClientHandler client : clients) {
            if ( client.getClientUsername().equals(userNamePrivateMessage)){
                client.sendMessage( s);
               //break;
            }
        }
        //clientName.sendMessage(s);
    }
}
